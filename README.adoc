...
== Overview
In this project, you will find two modules demonstrating sample Android implementations of a uService and a uClient. These implementations utilize the Binder uTransport (https://github.com/eclipse-uprotocol/up-transport-android-java/blob/main/README.adoc[Android uTransport]) for communication.
